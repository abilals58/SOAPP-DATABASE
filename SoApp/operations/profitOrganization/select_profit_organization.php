...
if (!empty($_POST['companyname'])){ 
    ...
    $sql_statement1 = "SELECT * FROM profit_organization WHERE company_name = '$companyname'"; 
    ...
    echo '<table border="1" cellspacing="2" cellpadding="2" style = "text-align:center" align="center"> 
      <tr > 
          ...
          <td> <u><font face="Arial">Stakeholder</font></u> </td>
          <td> <u><font face="Arial">Profit</font></u> </td>
    ...
    while ($row = $result1->fetch_assoc()) {
        ...
        $field3name = $row["stakeholders"];
        $field4name = $row["profit"];
